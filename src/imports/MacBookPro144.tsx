...
import svgPaths from "./svg-gb00ibkfw8";
...
function IconSkip({ additionalClassNames = "" }: IconSkipProps) {
  return (
    <Wrapper additionalClassNames={clsx("relative size-[24px]", additionalClassNames)}>
      <g id="IconSkip">
        <path d={svgPaths.p15833200} fill="var(--fill-0, white)" fillOpacity="0.5" id="Vector" />
        <path d={svgPaths.p34066e00} fill="var(--fill-0, white)" fillOpacity="0.5" id="Vector_2" />
      </g>
    </Wrapper>
  );
}
...
export default function MacBookPro() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[144px] py-[160px] relative size-full" data-name="MacBook Pro 14' - 4">
      <div className="bg-[rgba(0,0,0,0.5)] content-stretch flex flex-col gap-[16px] items-center justify-center p-[16px] relative rounded-[24px] shrink-0 w-[296px]">
        ...
        <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
          ...
          <Wrapper additionalClassNames="relative shrink-0 size-[24px]">
            <g id="IconPlay">
              <path d={svgPaths.p1ea95700} fill="var(--fill-0, white)" fillOpacity="0.8" id="Vector" />
            </g>
          </Wrapper>
